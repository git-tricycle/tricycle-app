  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      <ScrollView className="flex-1">
        {/* Header */}
        <View className="bg-indigo-600 px-6 py-8 rounded-b-3xl">
            ...
            <View className="flex-row space-x-4">
              ...
              >
                <View className="items-center">
                  ...
                  <Text className="text-gray-700 font-medium mt-2">Profile</Text>
                </View>
              </TouchableOpacity>
            </View>
          </View>
        ...
        <View className="px-6 mt-6">
          <View className="bg-white rounded-2xl p-6 shadow-sm">
            <Text className="text-gray-900 text-lg font-semibold mb-4">Recent Activity</Text>
        ...
        <View className="px-6 mt-6 mb-6">
          <View className="bg-white rounded-2xl p-6 shadow-sm">
            <Text className="text-gray-900 text-lg font-semibold mb-4">Safety Features</Text>
            ...
            <View className="space-y-3">
              <View className="flex-row items-center">
                ...
                <View className="flex-1">
                  <Text className="text-gray-900 font-medium">SOS Button</Text>
              ...
              <View className="flex-row items-center">
                ...
                <View className="flex-1">
                  <Text className="text-gray-900 font-medium">Share Trip</Text>
              ...
              <View className="flex-row items-center">
                ...
                <View className="flex-1">
                  <Text className="text-gray-900 font-medium">Verified Drivers</Text>
